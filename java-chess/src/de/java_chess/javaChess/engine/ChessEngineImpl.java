...
import de.java_chess.javaChess.engine.opening_book.*;
import de.java_chess.javaChess.engine.opening_book.action.*;
import de.java_chess.javaChess.engine.permanent_brain.*;
...
public class ChessEngineImpl implements ChessEngine, Runnable, ActionListener {
     ...
     */
    private boolean bFixedTime = true;
     ...
     * @param notation The current notation.
     ...
     *
     * @param permanentBrain The new permanent brain.
     */
     ...
     *
     * @param active Flag to indicate, if the permanent brain function should be used.
     */
     ...
     *
     * @param stopFlag The flag to stop the search engine.
     */
     ...
     *
     * @param analyzedBoards The new number of analyzed boards.
     */
	...
	f = new File(homedir, LOG_FILENAME );
	try{
